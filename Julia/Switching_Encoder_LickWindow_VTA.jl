...
base_path = "C:\\Research\\Encoder_Modeling\\Encoder_Analysis\\Processed_Encoder\\VTA_Stim\\"
...
for session_path in session_folders
    # try
        ...
        if prb == 1
            ...
            Probe1_R1, Probe2_R1, PCA_P1_R1, PCA_P2_R1, KP_R1, Jaw_R1 = load_data_encoder_noSVD(session_path, "Stim")
            Probe1_R4, Probe2_R4, PCA_P1_R4, PCA_P2_R4, KP_R4, Jaw_R4 = load_data_encoder_noSVD(session_path, "NoStim")

            Probe1_R1_Cut, Probe2_R1_Cut, PCA_P1_R1_Cut, PCA_P2_R1_Cut, KP_R1_Cut, FCs_R1, SCs_R1, LRCs_R1, Tongue_mat_R1, Jaw_R1_Cut = load_data_encoder_cut_noSVD(session_path, "Stim")
            Probe1_R4_Cut, Probe2_R4_Cut, PCA_P1_R4_Cut, PCA_P2_R4_Cut, KP_R4_Cut, FCs_R4, SCs_R4, LRCs_R4, Tongue_mat_R4, Jaw_R4_Cut = load_data_encoder_cut_noSVD(session_path, "NoStim")
        else
            println("Probe 2 Processing -> Check this!")
            Probe11_R1, Probe1_R1, PCA_P11_R1, PCA_P1_R1, KP_R1, Jaw_R1 = load_data_encoder_noSVD(session_path, "Stim")
            Probe11_R4, Probe1_R4, PCA_P11_R4, PCA_P1_R4, KP_R4, Jaw_R4 = load_data_encoder_noSVD(session_path, "NoStim")

            Probe11_R1_Cut, Probe1_R1_Cut, PCA_P11_R1_Cut, PCA_P1_R1_Cut, KP_R1_Cut, FCs_R1, SCs_R1, LRCs_R1, Tongue_mat_R1, Jaw_R1_Cut = load_data_encoder_cut_noSVD(session_path, "Stim")
            Probe11_R4_Cut, Probe1_R4_Cut, PCA_P11_R4_Cut, PCA_P1_R4_Cut, KP_R4_Cut, FCs_R4, SCs_R4, LRCs_R4, Tongue_mat_R4, Jaw_R4_Cut = load_data_encoder_cut_noSVD(session_path, "NoStim")
        end
        ...
        X_R1 = [X_R1_kernel[i][(FCs_R1[i]-3):(FCs_R1[i]+10), :] for i in eachindex(X_R1_kernel)]
        X_R4 = [X_R4_kernel[i][(FCs_R4[i]-3):(FCs_R4[i]+10), :] for i in eachindex(X_R4_kernel)]

        Y_R1 = [Y_R1_trimmed[i][(FCs_R1[i]-3):(FCs_R1[i]+10), :] for i in eachindex(Y_R1_trimmed)]
        ...
        β_eng, Σ_eng = weighted_ridge_regression(X_eng, Y_eng, 1000.0)
        ...
        if !isdir(joinpath("Results_Window_VTA_Aug\\" *session_save))
            mkpath(joinpath("Results_Window_VTA_Aug\\" *session_save))
        end

        println("**SAVE PATH**", (joinpath("Results_Window_VTA_Aug\\" *session_save, "VTA_PC_R2_Reg.csv")))
        ...
        CSV.write(joinpath("Results_Window_VTA_Aug\\" *session_save, "VTA_PC_R2_Reg.csv"), mean_r2_df; header=false)

        
        CSV.write(joinpath("Results_Window_VTA_Aug\\" *session_save, "NoStim_States_Reg.csv"), R4_States_df; header=false)
        CSV.write(joinpath("Results_Window_VTA_Aug\\" *session_save, "Stim_States_Reg.csv"), R1_States_df; header=false)
        CSV.write(joinpath("Results_Window_VTA_Aug\\" *session_save, "NoStim_States_Vit_Reg.csv"), R4_States_Vit_df; header=false)
        CSV.write(joinpath("Results_Window_VTA_Aug\\" *session_save, "Stim_States_Vit_Reg.csv"), R1_States_Vit_df; header=false)

        CSV.write(joinpath("Results_Window_VTA_Aug\\" *session_save, "NoStim_Tongue_Reg.csv"), R4_Tongue_df; header=false)
        CSV.write(joinpath("Results_Window_VTA_Aug\\" *session_save, "Stim_Tongue_Reg.csv"), R1_Tongue_df; header=false)
