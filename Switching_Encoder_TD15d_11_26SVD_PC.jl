...
# Load the data
_, λ_SVD_FRs, r2_train_SVD_FRs, r2_val_SVD_FRs, r2_test_SVD_FRs, r2_fullcut_SVD_FRs, best_β = load_results_from_csv("Results\\TD15d_11_26\\SVD_Red_To_Neural_PCs")
...
CSV.write(joinpath("Results\\TD15d_11_26\\SVD_Red_To_Neural_PCs" , "R4_Tongue_Reg.csv"), R4_Tongue_df; header=false)
CSV.write(joinpath("Results\\TD15d_11_26\\SVD_Red_To_Neural_PCs"  , "R1_Tongue_Reg.csv"), R1_Tongue_df; header=false)
CSV.write(joinpath("Results\\TD15d_11_26\\SVD_Red_To_Neural_PCs"  , "R4_States_Reg.csv"), R4_States_df; header=false)
CSV.write(joinpath("Results\\TD15d_11_26\\SVD_Red_To_Neural_PCs"  , "R1_States_Reg.csv"), R1_States_df; header=false)
