...
best_β, r2_test, r2_fullcut = fit_and_evaluate(SVD_R1_selected, SVD_R4_selected, Probe1_R1, Probe1_R4, LRCs, LRCs, λ_values, "Results\\TD15d_11_26\\SVD_Red_To_Neural_FRs")
best_β, r2_test, r2_fullcut = fit_and_evaluate(SVD_R1, SVD_R4, Probe1_R1, Probe1_R4, LRCs, LRCs, λ_values, "Results\\TD15d_11_26\\SVD_To_Neural_FRs")

"""
Section for testing SVD features to nerual PCs
"""

fit_and_evaluate(SVD_R1_selected, SVD_R4_selected, PCA_P1_R1, PCA_P1_R4 , LRCs, LRCs, λ_values, "Results\\TD15d_11_26\\SVD_Red_To_Neural_PCs")
fit_and_evaluate(SVD_R1, SVD_R4, PCA_P1_R1, PCA_P1_R4 , LRCs, LRCs, λ_values, "Results\\TD15d_11_26\\SVD_To_Neural_PCs")
...
fit_and_evaluate(KP_R1, KP_R4, Probe1_R1, Probe1_R4, LRCs, LRCs, λ_values, "Results\\TD15d_11_26\\KP_To_Neural_FRs")
...
fit_and_evaluate(KP_R1, KP_R4, PCA_P1_R1, PCA_P1_R4, LRCs, LRCs, λ_values, "Results\\TD15d_11_26\\KP_To_Neural_PCs")
...
_, λ_SVD_FRs, r2_train_SVD_FRs, r2_val_SVD_FRs, r2_test_SVD_FRs, r2_fullcut_SVD_FRs, _ = load_results_from_csv("Results\\TD15d_11_26\\SVD_To_Neural_FRs")
_, λ_SVD_PCs, r2_train_SVD_PCs, r2_val_SVD_PCs, r2_test_SVD_PCs, r2_fullcut_SVD_PCs, _ = load_results_from_csv("Results\\TD15d_11_26\\SVD_To_Neural_PCs")
_, λ_KP_FRs, r2_train_KP_FRs, r2_val_KP_FRs, r2_test_KP_FRs, r2_fullcut_KP_FRs, _ = load_results_from_csv("Results\\TD15d_11_26\\KP_To_Neural_FRs")
_, λ_KP_PCs, r2_train_KP_PCs, r2_val_KP_PCs, r2_test_KP_PCs, r2_fullcut_KP_PCs, _ = load_results_from_csv("Results\\TD15d_11_26\\KP_To_Neural_PCs")

_, λ_SVD_Select_FRs, r2_train_SVD_Select_FRs, r2_val_SVD_Select_FRs, r2_test_SVD_Select_FRs, r2_fullcut_SVD_Select_FRs, _ = load_results_from_csv("Results\\TD15d_11_26\\SVD_Red_To_Neural_FRs")
_, λ_SVD_Select_PCs, r2_train_SVD_Select_PCs, r2_val_SVD_Select_PCs, r2_test_SVD_Select_PCs, r2_fullcut_SVD_Select_PCs, _ = load_results_from_csv("Results\\TD15d_11_26\\SVD_Red_To_Neural_PCs")
